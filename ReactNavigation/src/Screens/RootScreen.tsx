...
export const RootScreen: React.FC<
  NativeStackScreenProps<StackScreens, "RootScreen">
> = (props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ alignItems: "center" }}>
        <TextInput
          style={styles.input}
          placeholder="Enter a value to pass to the next screen"
        ...
        {enteredValue.length > 0 && (
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              props.navigation.navigate("ScreenWithParams", {
                text: enteredValue,
              })
            }
          >
            <Text style={styles.buttonText}>
              Click to go to Simple Page With Params
            </Text>
          </TouchableOpacity>
        )}
      </View>
      <TouchableOpacity
        style={styles.button}
        onPress={() => props.navigation.navigate("ScreenWithTabs")}
      >
